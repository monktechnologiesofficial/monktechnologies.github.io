...
export function Button(props: ButtonAsButton | ButtonAsLink) {
  ...
  const base =
    "inline-flex items-center justify-center gap-2 rounded-xl font-semibold transition motion-reduce:transition-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-electric focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-60";
  ...
  const variants: Record<ButtonVariant, string> = {
    ...
    blue: "bg-electric text-white hover:brightness-110 active:brightness-95",
    secondary:
